...
function Features() {
    return (
        ...
        <div class="sm:container sm:min-h-[calc(100vh-20vh)] flex flex-col justify-center mx-auto items-center p-6 px-6 bg-white dark:bg-gray-800 poppins" data-aos="fade-down" data-aos-duration="1300">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center gap-8 text-center flex">
                <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg md:w-3/4 lg:w-1/4 dark:bg-gray-800">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-[#45008B] rounded-md">
                        <FaEye width="20" height="20" class="w-6 h-6"/>
                        </div>
                    </div>
                ...
                <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg md:w-3/4 md:w-1/2 lg:w-1/4 lg:mt-24 dark:bg-gray-800">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-[#45008B] rounded-md">
                            <FaPencil width="20" height="20" class="w-6 h-6"/>
                        </div>
                    </div>
                    <h3 class="py-4 text-2xl font-semibold text-gray-700 sm:text-xl dark:text-white">
                        Design Sur-Mesure
                ...
                <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg md:w-3/4  md:w-1/2 lg:w-1/4 dark:bg-gray-800">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-[#45008B] rounded-md">
                        <FaChartLine width="20" height="20" class="w-6 h-6"/>
                        </div>
                    </div>
                    <h3 class="py-4 text-2xl font-semibold text-gray-700 sm:text-xl dark:text-white">
