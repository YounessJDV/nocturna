          ...
          <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl mx-auto">
            <span className="relative inline-block">
              <svg
                viewBox="0 0 52 24"
                fill="currentColor"
                className="absolute top-0 left-0 z-0 hidden w-24 -mt-8 -ml-20 text-[#45008B] lg:w-24 sm:block"
              >
                <defs>
                  <pattern
              ...
              <span className="relative">Les offres de Nocturna</span>
            </span>{' '}
          </h2>
          ...
          <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
            <div className="mb-6">
              <div className="flex items-center justify-center pb-6 mb-6 border-b">
                <div>
                  <p className="mb-10 text-2xl font-bold tracking-wider uppercase">
